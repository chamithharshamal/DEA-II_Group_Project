  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (err.code === 'ERR_NETWORK') {
        setError('Cannot reach the admin service. Make sure it is running on port 8082.');
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <div style={{
            width: 56, height: 56, background: 'linear-gradient(135deg, #1a6fba, #1e90ff)',
            borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center',
            margin: '0 auto 16px', fontSize: 24,
          }}>🛡️</div>
          <h2 style={{ margin: 0, color: '#0f2d55', fontSize: '1.5rem', fontWeight: 700 }}>Admin Login</h2>
